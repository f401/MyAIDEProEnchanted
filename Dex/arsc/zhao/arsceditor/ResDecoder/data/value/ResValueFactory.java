...
public class ResValueFactory {
	...
	public ResScalarValue factory(int type, int value, String rawValue) throws IOException {
		switch (type) {
			case 0://TypedValue.TYPE_NULL:
				return new ResReferenceValue(mPackage, 0, null);
			case 0x1://TypedValue.TYPE_REFERENCE:
				return newReference(value, rawValue);
			case 0x2://TypedValue.TYPE_ATTRIBUTE:
				return newReference(value, rawValue, true);
			case 0x3:
				return new ResStringValue(rawValue, value);
			case 0x4://TypedValue.TYPE_FLOAT:
				return new ResFloatValue(Float.intBitsToFloat(value), value, rawValue);
			case 0x5: //TypedValue.TYPE_DIMENSION:
				return new ResDimenValue(value, rawValue);
			case 0x6://TypedValue.TYPE_FRACTION:
				return new ResFractionValue(value, rawValue);
			case 0x12: //TypedValue.TYPE_INT_BOOLEAN:
				return new ResBoolValue(value != 0, value, rawValue);
			case 0x07:
				return newReference(value, rawValue);
		}

		if (type >= /*TypedValue.TYPE_FIRST_COLOR_INT*/0x1c && type <= 0x1f/*TypedValue.TYPE_LAST_COLOR_INT*/) {
			return new ResColorValue(value, rawValue);
		}
		if (type >= /*TypedValue.TYPE_FIRST_INT*/0x10 && type <= 0x1f/*TypedValue.TYPE_LAST_INT*/) {
