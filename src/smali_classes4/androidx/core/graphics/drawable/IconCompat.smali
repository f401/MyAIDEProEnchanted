...
.method public static createFromIcon(Landroid/content/Context;Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    :try_end_2e
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_23 .. :try_end_2e} :catch_30
...
.method private static getResId(Landroid/graphics/drawable/Icon;)I
    ...
    :try_end_25
    .catch Ljava/lang/IllegalAccessException; {:try_start_c .. :try_end_25} :catch_3b
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_c .. :try_end_25} :catch_31
    .catch Ljava/lang/NoSuchMethodException; {:try_start_c .. :try_end_25} :catch_27
...
.method private static getResPackage(Landroid/graphics/drawable/Icon;)Ljava/lang/String;
    ...
    :try_end_22
    .catch Ljava/lang/IllegalAccessException; {:try_start_c .. :try_end_22} :catch_37
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_c .. :try_end_22} :catch_2d
    .catch Ljava/lang/NoSuchMethodException; {:try_start_c .. :try_end_22} :catch_23
...
.method private static getType(Landroid/graphics/drawable/Icon;)I
    ...
    invoke-virtual {v0}, Ljava/lang/Integer;->intValue()I
    :try_end_25
    .catch Ljava/lang/IllegalAccessException; {:try_start_c .. :try_end_25} :catch_59
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_c .. :try_end_25} :catch_40
    .catch Ljava/lang/NoSuchMethodException; {:try_start_c .. :try_end_25} :catch_27
...
.method private loadDrawableInner(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    :try_end_4b
    .catch Ljava/lang/Exception; {:try_start_44 .. :try_end_4b} :catch_86
    ...
    :try_end_d1
    .catch Ljava/lang/RuntimeException; {:try_start_c8 .. :try_end_d1} :catch_d4
...
.method public addToShortcutIntent(Landroid/content/Intent;Landroid/graphics/drawable/Drawable;Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v1, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    :try_end_53
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_3d .. :try_end_53} :catch_54
    ...
    :try_end_b6
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_6e .. :try_end_b6} :catch_54
