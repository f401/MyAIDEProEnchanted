.class Landroidj/support/v4/provider/DocumentsContractApi21;
...
.method public static createDirectory(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, p1, v0, p2}, Landroidj/support/v4/provider/DocumentsContractApi21;->createFile(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public static listFiles(Landroid/content/Context;Landroid/net/Uri;)[Landroid/net/Uri;
    ...
    :try_end_20
    .catch Ljava/lang/Exception; {:try_start_13 .. :try_end_20} :catch_67
    ...
    .catchall {:try_start_21 .. :try_end_33} :catchall_61
    ...
    invoke-static {v1}, Landroidj/support/v4/provider/DocumentsContractApi21;->closeQuietly(Ljava/lang/AutoCloseable;)V
    ...
    :goto_63
    invoke-static {v6}, Landroidj/support/v4/provider/DocumentsContractApi21;->closeQuietly(Ljava/lang/AutoCloseable;)V
