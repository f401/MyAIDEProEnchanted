...
.method constructor <init>(Landroid/content/Context;Ljava/util/Map;Labcd/kz;Landroid/os/Handler;Lio/fabric/sdk/android/m;ZLio/fabric/sdk/android/h;Lio/fabric/sdk/android/services/common/v;Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, v0}, Lio/fabric/sdk/android/Fabric;->createKitInitializationCallback(I)Lio/fabric/sdk/android/h;

    move-result-object v0

    iput-object v0, p0, Lio/fabric/sdk/android/Fabric;->kitInitializationCallback:Lio/fabric/sdk/android/h;
...
.method static synthetic access$300(Lio/fabric/sdk/android/Fabric;)Lio/fabric/sdk/android/h;
    ...
    iget-object v0, p0, Lio/fabric/sdk/android/Fabric;->initializationCallback:Lio/fabric/sdk/android/h;
...
.method private static addToKitMap(Ljava/util/Map;Ljava/util/Collection;)V
    ...
    instance-of v2, v0, Lio/fabric/sdk/android/k;
...
.method public static varargs with(Landroid/content/Context;[Lio/fabric/sdk/android/Kit;)Lio/fabric/sdk/android/Fabric;
    ...
    invoke-virtual {v0}, Lio/fabric/sdk/android/Fabric$Builder;->j6()Lio/fabric/sdk/android/Fabric;
...
.method addAnnotatedDependencies(Ljava/util/Map;Lio/fabric/sdk/android/Kit;)V
    ...
    iget-object v0, v0, Lio/fabric/sdk/android/Kit;->initializationTask:Lio/fabric/sdk/android/j;

    invoke-virtual {v6, v0}, Labcd/ez;->j6(Labcd/lz;)V
    ...
    iget-object v5, p2, Lio/fabric/sdk/android/Kit;->initializationTask:Lio/fabric/sdk/android/j;
    ...
    invoke-virtual {v5, v0}, Labcd/ez;->j6(Labcd/lz;)V
...
.method getKitsFinderFuture(Landroid/content/Context;)Ljava/util/concurrent/Future;
    ...
    invoke-direct {v0, v1}, Lio/fabric/sdk/android/f;-><init>(Ljava/lang/String;)V
...
.method initializeKits(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/Fabric;->idManager:Lio/fabric/sdk/android/services/common/v;

    invoke-virtual {v2, p1, p0, v0, v1}, Lio/fabric/sdk/android/Kit;->injectParameters(Landroid/content/Context;Lio/fabric/sdk/android/Fabric;Lio/fabric/sdk/android/h;Lio/fabric/sdk/android/services/common/v;)V
    ...
    invoke-virtual {v0, p1, p0, v4, v5}, Lio/fabric/sdk/android/Kit;->injectParameters(Landroid/content/Context;Lio/fabric/sdk/android/Fabric;Lio/fabric/sdk/android/h;Lio/fabric/sdk/android/services/common/v;)V
    ...
    invoke-interface {v0, v1, v4}, Lio/fabric/sdk/android/m;->j6(Ljava/lang/String;I)Z
    ...
    iget-object v4, v0, Lio/fabric/sdk/android/Kit;->initializationTask:Lio/fabric/sdk/android/j;

    iget-object v5, v2, Lio/fabric/sdk/android/Kit;->initializationTask:Lio/fabric/sdk/android/j;

    invoke-virtual {v4, v5}, Labcd/ez;->j6(Labcd/lz;)V
