...
.method private FH()Ljava/util/Map;
    ...
    invoke-direct {p0, v0, v2}, Lio/fabric/sdk/android/f;->j6(Ljava/util/zip/ZipEntry;Ljava/util/zip/ZipFile;)Lio/fabric/sdk/android/l;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lio/fabric/sdk/android/l;->DW()Ljava/lang/String;
    ...
    invoke-interface {v4, v5, v0}, Lio/fabric/sdk/android/m;->FH(Ljava/lang/String;Ljava/lang/String;)V
...
.method private j6(Ljava/util/zip/ZipEntry;Ljava/util/zip/ZipFile;)Lio/fabric/sdk/android/l;
    ...
    invoke-direct {v0, v3, v4, v5}, Lio/fabric/sdk/android/l;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_2
    invoke-static {v2}, Lio/fabric/sdk/android/services/common/i;->j6(Ljava/io/Closeable;)V
