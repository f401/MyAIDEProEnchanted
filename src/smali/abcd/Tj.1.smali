...
.method static constructor <clinit>()V
    ...
    const-wide v4, 0x35dca3995b5f490L
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    const-wide v2, 0x28314b3e1f39ada4L
    ...
    :cond_0
    const-string v0, "Engine service disconnected from UI"
    ...
    invoke-static {v0}, Labcd/Xj;->j6(Labcd/Xj;)Z

    move-result v0

    if-nez v0, :cond_1

    const-string v0, "Trying to restart engine service"

    invoke-static {v0}, Lcom/aide/common/AIDELog;->I(Ljava/lang/String;)V

    iget-object v0, p0, Labcd/Tj;->FH:Labcd/Xj;

    invoke-virtual {v0}, Labcd/Xj;->j6()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
