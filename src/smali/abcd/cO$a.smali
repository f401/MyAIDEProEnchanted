...
.method j6(Ljava/security/SecureRandom;Ljava/security/Provider;Z)Labcd/kO;
    ...
    invoke-virtual {v1, v2}, Labcd/nO;->j6(Z)Labcd/nO;

    iget-object v2, p0, Labcd/cO$a;->Zo:Labcd/WN;

    invoke-virtual {v1, v2}, Labcd/nO;->DW(Labcd/WN;)Labcd/nO;

    :try_start_0
    new-instance v2, Labcd/JP;

    invoke-direct {v2, v0}, Labcd/JP;-><init>(Ljava/lang/String;)V

    invoke-virtual {v2, p1}, Labcd/JP;->j6(Ljava/security/SecureRandom;)Labcd/JP;
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0

    if-eqz p2, :cond_1

    invoke-virtual {v2, p2}, Labcd/JP;->j6(Ljava/security/Provider;)Labcd/JP;

    :cond_1
    iget-object v0, p0, Labcd/cO$a;->j6:Ljava/security/PrivateKey;

    invoke-virtual {v2, v0}, Labcd/JP;->j6(Ljava/security/PrivateKey;)Labcd/vP;

    move-result-object v2

    iget-object v0, p0, Labcd/cO$a;->DW:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v2, v0}, Labcd/nO;->j6(Labcd/vP;Ljava/security/cert/X509Certificate;)Labcd/kO;
    ...
    invoke-virtual {v1, v2, v0}, Labcd/nO;->j6(Labcd/vP;[B)Labcd/kO;
