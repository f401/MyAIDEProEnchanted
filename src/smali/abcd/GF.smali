...
.method j6(Ljava/util/Locale;)V
    ...
    iput-object v0, p0, Labcd/GF;->resourceBundle:Ljava/util/ResourceBundle;
    :try_end_0
    .catch Ljava/util/MissingResourceException; {:try_start_0 .. :try_end_0} :catch_3

    iget-object v0, p0, Labcd/GF;->resourceBundle:Ljava/util/ResourceBundle;

    invoke-virtual {v0}, Ljava/util/ResourceBundle;->getLocale()Ljava/util/Locale;

    move-result-object v0

    iput-object v0, p0, Labcd/GF;->effectiveLocale:Ljava/util/Locale;
    ...
    invoke-direct {v2, v1, p1, v3, v0}, Labcd/xD;-><init>(Ljava/lang/Class;Ljava/util/Locale;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v2, v1, p1, v0}, Labcd/wD;-><init>(Ljava/lang/Class;Ljava/util/Locale;Ljava/lang/Exception;)V
