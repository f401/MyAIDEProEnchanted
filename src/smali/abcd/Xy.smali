...
.method static constructor <clinit>()V
    ...
    sget v0, Labcd/Xy;->j6:I

    add-int/lit8 v1, v0, 0x1

    sput v1, Labcd/Xy;->DW:I

    mul-int/lit8 v0, v0, 0x2

    add-int/lit8 v0, v0, 0x1

    sput v0, Labcd/Xy;->FH:I

    new-instance v0, Labcd/Ty;

    invoke-direct {v0}, Labcd/Ty;-><init>()V

    sput-object v0, Labcd/Xy;->Hw:Ljava/util/concurrent/ThreadFactory;
    ...
    sput-object v0, Labcd/Xy;->v5:Ljava/util/concurrent/BlockingQueue;

    new-instance v1, Ljava/util/concurrent/ThreadPoolExecutor;

    sget v2, Labcd/Xy;->DW:I

    sget v3, Labcd/Xy;->FH:I

    const-wide/16 v4, 0x1

    sget-object v6, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    sget-object v7, Labcd/Xy;->v5:Ljava/util/concurrent/BlockingQueue;

    sget-object v8, Labcd/Xy;->Hw:Ljava/util/concurrent/ThreadFactory;

    invoke-direct/range {v1 .. v8}, Ljava/util/concurrent/ThreadPoolExecutor;-><init>(IIJLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/BlockingQueue;Ljava/util/concurrent/ThreadFactory;)V

    sput-object v1, Labcd/Xy;->Zo:Ljava/util/concurrent/Executor;
    ...
    new-instance v0, Labcd/Xy$b;

    invoke-direct {v0}, Labcd/Xy$b;-><init>()V

    sput-object v0, Labcd/Xy;->gn:Labcd/Xy$b;

    sget-object v0, Labcd/Xy;->VH:Ljava/util/concurrent/Executor;
...
.method public constructor <init>()V
    ...
    new-instance v0, Labcd/Vy;

    iget-object v1, p0, Labcd/Xy;->tp:Labcd/Xy$e;

    invoke-direct {v0, p0, v1}, Labcd/Vy;-><init>(Labcd/Xy;Ljava/util/concurrent/Callable;)V

    iput-object v0, p0, Labcd/Xy;->EQ:Ljava/util/concurrent/FutureTask;
...
.method private Hw(Ljava/lang/Object;)V
    ...
    :goto_0
    sget-object v0, Labcd/Xy$d;->FH:Labcd/Xy$d;
...
.method private v5(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p0, v2}, Labcd/Xy$a;-><init>(Labcd/Xy;[Ljava/lang/Object;)V
