...
.method static constructor <clinit>()V
    ...
    const-wide v2, 0x674056976fcf104L
...
.method public constructor <init>()V
    ...
    const-wide v4, -0x5d518db3471d5b20L

    const/4 v3, 0x0

    :try_start_0
    sget-boolean v0, Labcd/Rg;->j6:Z

    if-eqz v0, :cond_0

    const-wide v0, -0x5d518db3471d5b20L
...
.method public FH()Lcom/aide/common/u;
    ...
    const-wide v6, 0x1d8d549802320db0L    # 2.486972887606338E-166
...
.method public isEnabled()Z
    ...
    const-wide v4, 0x262f5ac0e54091fL

    const/4 v0, 0x1

    :try_start_0
    sget-boolean v1, Labcd/Rg;->j6:Z

    if-eqz v1, :cond_0

    const-wide v2, 0x262f5ac0e54091fL
    ...
    invoke-virtual {v1}, Labcd/Nk;->u7()Z
    ...
    invoke-virtual {v1}, Labcd/Nk;->Zo()Z
    ...
    invoke-virtual {v1}, Labcd/Tl;->DW()Z
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public j6()I
    ...
    const-wide v2, -0x76fc62dc9e30b9bL    # -5.486102476567545E272
...
.method public j6(Z)Z
    ...
    const-wide v2, -0x19e93acf802aa43L    # -5.834077053053184E300
...
.method public run()Z
    ...
    const-wide v6, -0x8490a3fb6fb001fL    # -4.738134413151439E268
    ...
    invoke-virtual/range {v0 .. v5}, Labcd/ul;->FH(Ljava/lang/String;IIII)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
