...
.method private j6(Labcd/jC;)V
    ...
    iget v4, p1, Labcd/jC;->Hw:I

    invoke-virtual {v0, v1, v2, v3, v4}, Labcd/sC$a;->DW(IIII)V

    iget-object v0, p0, Labcd/sC;->Zo:Labcd/sC$a;

    iget v1, v0, Labcd/sC$a;->FH:I

    iget v2, v0, Labcd/sC$a;->Hw:I

    if-lt v1, v2, :cond_0

    iget v1, v0, Labcd/sC$a;->v5:I
    ...
    iget v3, v0, Labcd/sC$a;->v5:I

    iget v0, v0, Labcd/sC$a;->Zo:I

    invoke-virtual {p0, v1, v2, v3, v0}, Labcd/sC;->j6(IIII)V
...
.method protected j6(IIII)V
    ...
    sget-object v2, Labcd/jC$a;->Hw:Labcd/jC$a;

    if-eq v1, v2, :cond_2

    iget-object v1, p0, Labcd/sC;->DW:Labcd/kC;
    ...
    :cond_2
    iget v1, v0, Labcd/jC;->DW:I

    if-gt p2, v1, :cond_3

    iget v1, v0, Labcd/jC;->Hw:I
    ...
    iget-object v2, p0, Labcd/sC;->Zo:Labcd/sC$a;

    iget-object v2, v2, Labcd/sC$a;->j6:Labcd/sC$a$b;

    invoke-virtual {v2, v1, v0}, Labcd/sC$a$b;->VH(II)I

    move-result v0

    add-int/2addr v1, v0

    invoke-virtual {p0, v0, p2, v1, p4}, Labcd/sC;->j6(IIII)V
