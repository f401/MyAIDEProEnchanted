...
.method static constructor <clinit>()V
    ...
    const-wide v2, -0x28c03c4a48b96510L
...
.method public constructor <init>()V
    ...
    const-wide v4, 0x3f10344b16bfc025L    # 6.181438737917816E-5

    const/4 v3, 0x0

    :try_start_0
    sget-boolean v0, Labcd/Qh;->u7:Z

    if-eqz v0, :cond_0

    const-wide v0, 0x3f10344b16bfc025L    # 6.181438737917816E-5
...
.method protected EQ()Ljava/lang/String;
    ...
    const-wide v2, 0x235175434d79315dL    # 1.466013401386468E-138
    ...
    invoke-virtual {v0}, Labcd/Ji;->DW()Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected J0()V
    ...
    const-wide v2, -0x4e77a28faf3f8bc0L    # -4.412831518157349E-70
    ...
    invoke-virtual {v0, p0}, Labcd/Ji;->DW(Labcd/Ji$c;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected Ws()Z
    ...
    const-wide v2, -0xce0ca341cd8eb6cL    # -3.409668988363629E246
...
.method protected Zo()V
    ...
    const-wide v2, 0xca6a70e6fb0d808L
    ...
    invoke-virtual {v0}, Labcd/Ji;->j6()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected gn()I
    ...
    const-wide v2, -0x257e961bbf7625c0L    # -9.43013074196633E127
    ...
    invoke-virtual {v0}, Labcd/Ji;->FH()I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public j6()V
    ...
    const-wide v2, -0x40592013fe4aa62dL    # -0.0446771385274364
...
.method protected tp()Ljava/lang/String;
    ...
    const-wide v2, -0x103b30a9596d5648L    # -2.5240446083889625E230
    ...
    invoke-virtual {v0}, Labcd/Ji;->v5()Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected u7()I
    ...
    const-wide v2, -0x1bdd76f162637ddfL    # -2.2921813978331333E174
    ...
    invoke-virtual {v0}, Labcd/Ji;->Hw()I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected v5()Z
    ...
    const-wide v2, 0x408cc0e47aadacbcL    # 920.1115621155109
...
.method protected we()V
    ...
    const-wide v2, -0x3d07ffd529860adbL    # -4.222239642499383E14
    ...
    invoke-virtual {v0, p0}, Labcd/Ji;->j6(Labcd/Ji$c;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
