...
.method constructor <init>(Labcd/gE;)V
    ...
    iput-boolean v0, p0, Labcd/SI$a;->DW:Z

    iput-boolean v3, p0, Labcd/SI$a;->FH:Z

    const-string v0, "receive"

    const-string v1, "denydeletes"
    ...
    iput-boolean v0, p0, Labcd/SI$a;->Hw:Z

    const-string v0, "receive"

    const-string v1, "denynonfastforwards"
    ...
    invoke-virtual {p1, v0, v1, v3}, Labcd/gE;->j6(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Labcd/SI$a;->Zo:Z
