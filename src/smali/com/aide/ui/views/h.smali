...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/aide/ui/views/h;

    const-wide v2, 0x1531a05ac6f9b43cL

    const-wide v4, -0x1ed89a562a1a6949L    # -1.0279456857743656E160
...
.method protected getColumn()I
    ...
    const-wide v2, -0x445a9e5b6a7de9e0L
    ...
    invoke-virtual {v0}, Lcom/aide/ui/views/editor/OConsole;->getSelectionPointColumn()I
    :try_end_0
...
.method protected getLine()I
    ...
    const-wide v2, 0x23e5c6e713991e94L    # 9.362876316508974E-136
    ...
    invoke-virtual {v0}, Lcom/aide/ui/views/editor/OConsole;->getSelectionPointLine()I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onClick()V
    ...
    const-wide v2, -0x2f44c637937862b3L    # -8.070457242200328E80
...
.method protected onDraggedTo(II)V
    ...
    const-wide v4, -0x14bd942ff1fbeea4L    # -4.7313338777889675E208
    ...
    iget-object v4, p0, Lcom/aide/ui/views/h;->this$0:Lcom/aide/ui/views/CodeEditTextScrollView;
    ...
    invoke-virtual {v4}, Lcom/aide/ui/views/editor/OConsole;->getSelectionAnchorColumn()I

    move-result v4

    invoke-virtual {v0, v1, v4, p1, p2}, Lcom/aide/ui/views/editor/OConsole;->j6(IIII)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    sget-boolean v0, Lcom/aide/ui/views/h;->$ON_THROW_TOGGLE:Z
