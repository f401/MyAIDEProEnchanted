...
.method public j6(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/media/MediaBrowserCompat$n;->j6(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, v2}, Landroid/support/v4/media/MediaBrowserCompat$n;->j6(Ljava/lang/String;Ljava/util/List;)V
    ...
    :cond_3
    iget-object v5, p0, Landroid/support/v4/media/MediaBrowserCompat$n$a;->j6:Landroid/support/v4/media/MediaBrowserCompat$n;

    invoke-virtual {p0, v2, v0}, Landroid/support/v4/media/MediaBrowserCompat$n$a;->j6(Ljava/util/List;Landroid/os/Bundle;)Ljava/util/List;

    move-result-object v6

    invoke-virtual {v5, p1, v6, v0}, Landroid/support/v4/media/MediaBrowserCompat$n;->j6(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)V
