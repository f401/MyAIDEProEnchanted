...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/CircularProgressDrawable;->Zo:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/CircularProgressDrawable;->Hw:Landroid/support/v4/widget/CircularProgressDrawable$a;
    ...
    sget-object v1, Landroid/support/v4/widget/CircularProgressDrawable;->FH:[I

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/CircularProgressDrawable$a;->j6([I)V

    const/high16 v0, 0x40200000    # 2.5f

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/CircularProgressDrawable;->FH(F)V
...
.method private DW(FLandroid/support/v4/widget/CircularProgressDrawable$a;)V
    ...
    invoke-direct {p0, v0, v1, v2}, Landroid/support/v4/widget/CircularProgressDrawable;->j6(FII)I

    move-result v0

    invoke-virtual {p2, v0}, Landroid/support/v4/widget/CircularProgressDrawable$a;->DW(I)V
...
.method static synthetic j6(Landroid/support/v4/widget/CircularProgressDrawable;)F
    ...
    iget v0, p0, Landroid/support/v4/widget/CircularProgressDrawable;->gn:F
...
.method private j6(FFFF)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/CircularProgressDrawable$a;->Zo(F)V

    mul-float v2, p1, v1

    invoke-virtual {v0, v2}, Landroid/support/v4/widget/CircularProgressDrawable$a;->DW(F)V

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Landroid/support/v4/widget/CircularProgressDrawable$a;->FH(I)V

    mul-float v2, p3, v1

    mul-float/2addr v1, p4

    invoke-virtual {v0, v2, v1}, Landroid/support/v4/widget/CircularProgressDrawable$a;->j6(FF)V
...
.method private j6(FLandroid/support/v4/widget/CircularProgressDrawable$a;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/widget/CircularProgressDrawable$a;->Hw(F)V
...
.method private j6(FLandroid/support/v4/widget/CircularProgressDrawable$a;Z)V
    ...
    sget-object v3, Landroid/support/v4/widget/CircularProgressDrawable;->DW:Landroid/view/animation/Interpolator;
    ...
    :goto_1
    iget v3, p0, Landroid/support/v4/widget/CircularProgressDrawable;->gn:F
...
.method public j6(FF)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v4/widget/CircularProgressDrawable$a;->FH(F)V
...
.method public j6(I)V
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Landroid/support/v4/widget/CircularProgressDrawable;->j6(FFFF)V
