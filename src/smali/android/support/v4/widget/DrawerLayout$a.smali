...
.method constructor <init>(Landroid/support/v4/widget/DrawerLayout;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout$a;->Hw:Landroid/graphics/Rect;
...
.method public j6(Landroid/view/View;Labcd/A;)V
    ...
    invoke-virtual {p2, v3}, Labcd/A;->Hw(Z)V

    invoke-virtual {p2, v3}, Labcd/A;->v5(Z)V

    sget-object v0, Labcd/A$a;->j6:Labcd/A$a;

    invoke-virtual {p2, v0}, Labcd/A;->j6(Labcd/A$a;)Z

    sget-object v0, Labcd/A$a;->DW:Labcd/A$a;
    ...
    invoke-super {p0, p1, v1}, Landroid/support/v4/view/c;->j6(Landroid/view/View;Labcd/A;)V
    ...
    :cond_1
    invoke-direct {p0, p2, v1}, Landroid/support/v4/widget/DrawerLayout$a;->j6(Labcd/A;Labcd/A;)V

    invoke-virtual {v1}, Labcd/A;->Mr()V
...
.method public j6(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout$a;->v5:Landroid/support/v4/widget/DrawerLayout;

    invoke-virtual {v1}, Landroid/support/v4/widget/DrawerLayout;->Hw()Landroid/view/View;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout$a;->v5:Landroid/support/v4/widget/DrawerLayout;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/DrawerLayout;->Hw(I)Ljava/lang/CharSequence;
