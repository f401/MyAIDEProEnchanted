...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;I)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/Y$a;->j6:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroid/support/v4/app/Y$a;->DW:Landroid/os/Bundle;

    if-eqz p20, :cond_0

    iget-object v4, p0, Landroid/support/v4/app/Y$a;->DW:Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroid/support/v4/app/Y$a;->DW:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroid/support/v4/app/Y$a;->FH:Landroid/widget/RemoteViews;

    move-object/from16 v0, p25

    iput-object v0, p0, Landroid/support/v4/app/Y$a;->Hw:Landroid/widget/RemoteViews;

    move/from16 v0, p26

    iput v0, p0, Landroid/support/v4/app/Y$a;->v5:I
...
.method public build()Landroid/app/Notification;
    ...
    iget-object v0, p0, Landroid/support/v4/app/Y$a;->j6:Landroid/app/Notification$Builder;

    iget-object v1, p0, Landroid/support/v4/app/Y$a;->DW:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/app/Y$a;->FH:Landroid/widget/RemoteViews;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/Y$a;->Hw:Landroid/widget/RemoteViews;
    ...
    :cond_1
    iget v1, p0, Landroid/support/v4/app/Y$a;->v5:I
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/app/Y$a;->j6(Landroid/app/Notification;)V
