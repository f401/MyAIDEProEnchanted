...
.method constructor <init>(Landroid/support/v4/app/a;Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-boolean v0, p0, Landroid/support/v4/app/a$d;->j6:Z

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/a$d;->DW:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/a$d;->DW:Landroid/graphics/Rect;

    invoke-virtual {p0, v1}, Landroid/graphics/drawable/InsetDrawable;->copyBounds(Landroid/graphics/Rect;)V

    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget-object v1, p0, Landroid/support/v4/app/a$d;->v5:Landroid/support/v4/app/a;

    iget-object v1, v1, Landroid/support/v4/app/a;->DW:Landroid/app/Activity;
    ...
    invoke-static {v1}, Landroid/support/v4/view/s;->Hw(Landroid/view/View;)I
