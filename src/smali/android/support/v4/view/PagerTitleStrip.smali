...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroid/support/v4/view/PagerTitleStrip;->VH:I

    const/high16 v1, -0x40800000    # -1.0f

    iput v1, p0, Landroid/support/v4/view/PagerTitleStrip;->gn:F
    ...
    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->J0:Landroid/support/v4/view/PagerTitleStrip$a;

    new-instance v1, Landroid/widget/TextView;

    invoke-direct {v1, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->Hw:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->v5:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->Zo:Landroid/widget/TextView;

    invoke-virtual {p0, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    sget-object v1, Landroid/support/v4/view/PagerTitleStrip;->j6:[I
    ...
    invoke-static {v3, v2}, Landroid/support/v4/widget/t;->j6(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v0, v3}, Landroid/support/v4/view/PagerTitleStrip;->j6(IF)V
    ...
    iget-object v4, p0, Landroid/support/v4/view/PagerTitleStrip;->Zo:Landroid/widget/TextView;
    ...
    iput v3, p0, Landroid/support/v4/view/PagerTitleStrip;->tp:I

    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    iget-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->v5:Landroid/widget/TextView;
    ...
    iput v1, p0, Landroid/support/v4/view/PagerTitleStrip;->QX:I

    const v1, 0x3f19999a    # 0.6f

    invoke-virtual {p0, v1}, Landroid/support/v4/view/PagerTitleStrip;->setNonPrimaryAlpha(F)V

    iget-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->Hw:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->Zo:Landroid/widget/TextView;
    ...
    sget-object v1, Landroid/support/v4/view/PagerTitleStrip;->DW:[I
    ...
    iput v0, p0, Landroid/support/v4/view/PagerTitleStrip;->u7:I
...
.method j6(IFZ)V
    ...
    iget v2, v0, Landroid/support/v4/view/PagerTitleStrip;->VH:I
    ...
    iput-boolean v2, v0, Landroid/support/v4/view/PagerTitleStrip;->we:Z

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/support/v4/view/PagerTitleStrip;->Hw:Landroid/widget/TextView;
    ...
    iget v3, v0, Landroid/support/v4/view/PagerTitleStrip;->tp:I
    ...
    iget-object v3, v0, Landroid/support/v4/view/PagerTitleStrip;->Hw:Landroid/widget/TextView;
    ...
    iget v3, v0, Landroid/support/v4/view/PagerTitleStrip;->u7:I
    ...
    iget-object v3, v0, Landroid/support/v4/view/PagerTitleStrip;->Zo:Landroid/widget/TextView;
    ...
    iput v0, v1, Landroid/support/v4/view/PagerTitleStrip;->gn:F
    ...
    iget v2, v0, Landroid/support/v4/view/PagerTitleStrip;->gn:F
...
.method j6(ILandroid/support/v4/view/o;)V
    ...
    iget-boolean v0, p0, Landroid/support/v4/view/PagerTitleStrip;->we:Z

    if-nez v0, :cond_1

    iget v0, p0, Landroid/support/v4/view/PagerTitleStrip;->gn:F

    invoke-virtual {p0, p1, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->j6(IFZ)V

    :cond_1
    iput-boolean v1, p0, Landroid/support/v4/view/PagerTitleStrip;->EQ:Z
...
.method j6(Landroid/support/v4/view/o;Landroid/support/v4/view/o;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->J8:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/o;->j6(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->j6(ILandroid/support/v4/view/o;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/view/PagerTitleStrip;->j6(Landroid/support/v4/view/o;Landroid/support/v4/view/o;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->J0:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->DW(Landroid/support/v4/view/ViewPager$d;)V

    iput-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->FH:Landroid/support/v4/view/ViewPager;
...
.method protected onLayout(ZIIII)V
    ...
    :goto_0
    iget v1, p0, Landroid/support/v4/view/PagerTitleStrip;->VH:I

    const/4 v2, 0x1

    invoke-virtual {p0, v1, v0, v2}, Landroid/support/v4/view/PagerTitleStrip;->j6(IFZ)V
...
.method protected onMeasure(II)V
    ...
    invoke-static {p1, v3, v5}, Landroid/view/ViewGroup;->getChildMeasureSpec(III)I
...
.method public setNonPrimaryAlpha(F)V
    ...
    iput v0, p0, Landroid/support/v4/view/PagerTitleStrip;->Ws:I

    iget v0, p0, Landroid/support/v4/view/PagerTitleStrip;->Ws:I
