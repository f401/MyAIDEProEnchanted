...
.method constructor <init>(Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->FH:Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;
...
.method private static j6(Ljava/lang/Class;)Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;
    ...
    invoke-static {v6, v1, v0, p0}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->j6(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/a$a;Ljava/lang/Class;)V
    ...
    :goto_4
    invoke-interface {v0}, Landroid/arch/lifecycle/g;->value()Landroid/arch/lifecycle/a$a;
    ...
    const-class v11, Landroid/arch/lifecycle/a$a;
    ...
    invoke-static {v6, v10, v0, p0}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->j6(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/a$a;Ljava/lang/Class;)V
...
.method private j6(Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/a$a;)V
    ...
    :cond_0
    iget-object v0, p1, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;->DW:Ljava/lang/reflect/Method;

    iget-object v1, p0, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->DW:Ljava/lang/Object;
...
.method private j6(Ljava/util/List;Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/a$a;)V
    ...
    invoke-direct {p0, v0, p2, p3}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->j6(Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/a$a;)V
...
.method private static j6(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/a$a;Ljava/lang/Class;)V
    ...
    :cond_2
    iget-object v1, p1, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;->DW:Ljava/lang/reflect/Method;
    ...
    const-string v1, " already declared with different @OnLifecycleEvent value: previous"
