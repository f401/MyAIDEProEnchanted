...
.method constructor <init>()V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->FH:Landroid/graphics/Paint;

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->Hw:Landroid/graphics/Paint;

    const/4 v3, 0x0

    iput v3, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->v5:F

    iput v3, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->Zo:F

    iput v3, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->VH:F

    const/high16 v3, 0x40a00000  # 5.0f

    iput v3, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->gn:F

    const/high16 v3, 0x3f800000  # 1.0f

    iput v3, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->QX:F

    const/16 v3, 0xff

    iput v3, p0, Landroid/support/v4/widget/CircularProgressDrawable$a;->Mr:I
...
.method j6([I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/CircularProgressDrawable$a;->FH(I)V
