.class public Landroid/support/v4/app/da$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/support/v4/app/da;
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;ZLandroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v5, v0, Landroid/support/v4/app/da$a;->FH:Ljava/util/List;
    ...
    :goto_a7
    invoke-virtual {v5, v1, v8}, Landroid/app/Notification$Builder;->setFullScreenIntent(Landroid/app/PendingIntent;Z)Landroid/app/Notification$Builder;
    ...
    iput-object v1, v0, Landroid/support/v4/app/da$a;->j6:Landroid/app/Notification$Builder;

    new-instance v1, Landroid/os/Bundle;

    invoke-direct {v1}, Landroid/os/Bundle;-><init>()V

    iput-object v1, v0, Landroid/support/v4/app/da$a;->DW:Landroid/os/Bundle;
    ...
    iput-object v1, v0, Landroid/support/v4/app/da$a;->Hw:Landroid/widget/RemoteViews;

    move-object/from16 v1, p23

    iput-object v1, v0, Landroid/support/v4/app/da$a;->v5:Landroid/widget/RemoteViews;
...
.method public build()Landroid/app/Notification;
    ...
    iget-object v0, p0, Landroid/support/v4/app/da$a;->j6:Landroid/app/Notification$Builder;

    invoke-virtual {v0}, Landroid/app/Notification$Builder;->build()Landroid/app/Notification;

    move-result-object v0

    invoke-static {v0}, Landroid/support/v4/app/da;->j6(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v2, Landroid/os/Bundle;

    iget-object v3, p0, Landroid/support/v4/app/da$a;->DW:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/app/da$a;->FH:Ljava/util/List;

    invoke-static {v1}, Landroid/support/v4/app/da;->j6(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    :cond_45
    iget-object v1, p0, Landroid/support/v4/app/da$a;->Hw:Landroid/widget/RemoteViews;
    ...
    :cond_4b
    iget-object v1, p0, Landroid/support/v4/app/da$a;->v5:Landroid/widget/RemoteViews;
...
.method public j6(Landroid/support/v4/app/ca;)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/da$a;->FH:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/da$a;->j6:Landroid/app/Notification$Builder;
