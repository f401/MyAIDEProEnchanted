...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/media/MediaBrowserServiceCompat$i;->j6(Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
.end annotation
...
.method constructor <init>(Landroid/support/v4/media/MediaBrowserServiceCompat$i;Landroid/support/v4/media/MediaBrowserServiceCompat$j;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/q;->DW:Landroid/support/v4/media/MediaBrowserServiceCompat$i;

    iput-object p2, p0, Landroid/support/v4/media/q;->j6:Landroid/support/v4/media/MediaBrowserServiceCompat$j;
...
.method public run()V
    ...
    iget-object v0, p0, Landroid/support/v4/media/q;->j6:Landroid/support/v4/media/MediaBrowserServiceCompat$j;

    invoke-interface {v0}, Landroid/support/v4/media/MediaBrowserServiceCompat$j;->asBinder()Landroid/os/IBinder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/q;->DW:Landroid/support/v4/media/MediaBrowserServiceCompat$i;
