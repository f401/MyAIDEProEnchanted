.class public Lsun1/security/x509/SubjectAlternativeNameExtension;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->names:Lsun1/security/x509/GeneralNames;

    sget-object v0, Lsun1/security/x509/PKIXExtensions;->SubjectAlternativeName_Id:Lsun1/security/util/ObjectIdentifier;

    iput-object v0, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->extensionId:Lsun1/security/util/ObjectIdentifier;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->critical:Z
...
.method public constructor <init>(Ljava/lang/Boolean;Ljava/lang/Object;)V
    ...
    iput-object p2, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->extensionValue:[B

    new-instance v0, Lsun1/security/util/DerValue;

    iget-object v1, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->extensionValue:[B
    ...
    iput-object v1, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->names:Lsun1/security/x509/GeneralNames;

    goto :goto_0
.end method

.method public constructor <init>(Ljava/lang/Boolean;Lsun1/security/x509/GeneralNames;)V
    .registers 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iput-object p2, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->names:Lsun1/security/x509/GeneralNames;
    ...
    invoke-direct {p0}, Lsun1/security/x509/SubjectAlternativeNameExtension;->encodeThis()V
...
.method public constructor <init>(Lsun1/security/x509/GeneralNames;)V
    ...
    invoke-direct {p0, v0, p1}, Lsun1/security/x509/SubjectAlternativeNameExtension;-><init>(Ljava/lang/Boolean;Lsun1/security/x509/GeneralNames;)V
...
.method private encodeThis()V
    ...
    iget-object v0, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->names:Lsun1/security/x509/GeneralNames;
    ...
    iput-object v0, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->extensionValue:[B
    ...
    iget-object v1, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->names:Lsun1/security/x509/GeneralNames;
...
.method public encode(Ljava/io/OutputStream;)V
    ...
    iput-object v1, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->extensionId:Lsun1/security/util/ObjectIdentifier;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lsun1/security/x509/SubjectAlternativeNameExtension;->critical:Z
