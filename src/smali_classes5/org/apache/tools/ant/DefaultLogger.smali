...
.method public messageLogged(Lorg/apache/tools/ant/BuildEvent;)V
    ...
    :try_end_ae
    .catch Ljava/io/IOException; {:try_start_a0 .. :try_end_ae} :catch_d9
    ...
    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;
    :try_end_d4
    .catchall {:try_start_ae .. :try_end_d4} :catchall_e8
    ...
    invoke-virtual {v4}, Ljava/io/BufferedReader;->close()V
    :try_end_ec
    .catchall {:try_start_e9 .. :try_end_ec} :catchall_f4

    :goto_ec
    :try_start_ec
    throw v0
    :try_end_ed
    .catch Ljava/io/IOException; {:try_start_ec .. :try_end_ed} :catch_d9
