...
.method public static isCaseSensitiveFileSystem(Ljava/nio/file/Path;)Ljava/util/Optional;
    ...
    :try_end_19
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_19} :catch_5f
    .catchall {:try_start_4 .. :try_end_19} :catchall_8d
    ...
    :try_end_2a
    .catch Ljava/io/IOException; {:try_start_1a .. :try_end_2a} :catch_a1
    .catchall {:try_start_1a .. :try_end_2a} :catchall_a4
    ...
    :try_end_2e
    .catch Ljava/nio/file/NoSuchFileException; {:try_start_2b .. :try_end_2e} :catch_57
    .catch Ljava/io/IOException; {:try_start_2b .. :try_end_2e} :catch_a1
    .catchall {:try_start_2b .. :try_end_2e} :catchall_a4
    ...
    :try_end_5d
    .catch Ljava/io/IOException; {:try_start_44 .. :try_end_5d} :catch_5f
    .catchall {:try_start_44 .. :try_end_5d} :catchall_8d
    ...
    invoke-static {}, Ljava/util/Optional;->empty()Ljava/util/Optional;
    :try_end_82
    .catchall {:try_start_61 .. :try_end_82} :catchall_8d
...
.method private isSameFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    :try_end_18
    .catch Ljava/nio/file/NoSuchFileException; {:try_start_7 .. :try_end_18} :catch_3a
...
.method public createTempFile(Lorg/apache/tools/ant/Project;Ljava/lang/String;Ljava/lang/String;Ljava/io/File;ZZ)Ljava/io/File;
    ...
    invoke-interface {v0}, Ljava/nio/file/Path;->toFile()Ljava/io/File;
    :try_end_34
    .catch Ljava/io/IOException; {:try_start_15 .. :try_end_34} :catch_a3
    ...
    :try_end_8c
    .catch Ljava/io/IOException; {:try_start_7a .. :try_end_8c} :catch_f6
    ...
    :try_end_92
    .catch Ljava/io/IOException; {:try_start_8d .. :try_end_92} :catch_94
    ...
    :try_end_a2
    .catch Ljava/io/IOException; {:try_start_a0 .. :try_end_a2} :catch_a3
    ...
    monitor-exit v3
    :try_end_f5
    .catchall {:try_start_c5 .. :try_end_f5} :catchall_f3
