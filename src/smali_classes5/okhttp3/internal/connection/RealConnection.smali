...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_end_43
    .catch Ljava/net/ConnectException; {:try_start_34 .. :try_end_43} :catch_75
    ...
    :try_end_5b
    .catch Ljava/lang/NullPointerException; {:try_start_43 .. :try_end_5b} :catch_62
    ...
    invoke-direct {v2, v1}, Ljava/net/ConnectException;-><init>(Ljava/lang/String;)V
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    :try_end_24
    .catch Ljava/lang/AssertionError; {:try_start_b .. :try_end_24} :catch_14a
    .catchall {:try_start_b .. :try_end_24} :catchall_c4
    ...
    throw v2
    :try_end_b6
    .catch Ljava/lang/AssertionError; {:try_start_24 .. :try_end_b6} :catch_b6
    .catchall {:try_start_24 .. :try_end_b6} :catchall_f7
    ...
    throw v0
    :try_end_c4
    .catchall {:try_start_b8 .. :try_end_c4} :catchall_c4
    ...
    :try_end_13d
    .catch Ljava/lang/AssertionError; {:try_start_d3 .. :try_end_13d} :catch_b6
    .catchall {:try_start_d3 .. :try_end_13d} :catchall_f7
    ...
    :try_end_149
    .catch Ljava/lang/AssertionError; {:try_start_147 .. :try_end_149} :catch_b6
    .catchall {:try_start_147 .. :try_end_149} :catchall_f7
    ...
    throw v1
    :try_end_14f
    .catchall {:try_start_14e .. :try_end_14f} :catchall_c4
.end method
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-direct {p0, p2, p3, v0, v2}, Lokhttp3/internal/connection/RealConnection;->createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-static {p4, v2}, Lokhttp3/internal/Util;->hostHeader(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    invoke-direct {v2, v0, v0, v3, v4}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/BufferedSource;Lokio/BufferedSink;)V
    ...
    invoke-virtual {v3, p3}, Lokhttp3/Response$Builder;->request(Lokhttp3/Request;)Lokhttp3/Response$Builder;
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/http1/Http1ExchangeCodec;->skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-interface {v2, v4, v3}, Lokhttp3/Authenticator;->authenticate(Lokhttp3/Route;Lokhttp3/Response;)Lokhttp3/Request;
...
.method private createTunnelRequest()Lokhttp3/Request;
    ...
    invoke-virtual {v0, v2, v3}, Lokhttp3/Response$Builder;->header(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/Response$Builder;
...
.method private routeMatchesAny(Ljava/util/List;)Z
    ...
    invoke-virtual {v4, v0}, Ljava/net/InetSocketAddress;->equals(Ljava/lang/Object;)Z
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;
    :try_end_54
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_54} :catch_13e
    ...
    monitor-exit v1
    :try_end_72
    .catchall {:try_start_69 .. :try_end_72} :catchall_12a
    ...
    :try_end_c3
    .catch Ljava/io/IOException; {:try_start_c0 .. :try_end_c3} :catch_12d
    ...
    :try_end_d7
    .catch Ljava/io/IOException; {:try_start_c3 .. :try_end_d7} :catch_d9
...
.method isEligible(Lokhttp3/Address;Ljava/util/List;)Z
    ...
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->transmitters:Ljava/util/List;
    ...
    iget-boolean v2, p0, Lokhttp3/internal/connection/RealConnection;->noNewExchanges:Z
    ...
    :try_end_74
    .catch Ljavax/net/ssl/SSLPeerUnverifiedException; {:try_start_5d .. :try_end_74} :catch_76
...
.method public isHealthy(Z)Z
    ...
    :try_end_2f
    .catch Ljava/net/SocketTimeoutException; {:try_start_2a .. :try_end_2f} :catch_44
    ...
    throw v2
    :try_end_55
    .catch Ljava/net/SocketTimeoutException; {:try_start_3e .. :try_end_55} :catch_44
    .catch Ljava/io/IOException; {:try_start_3e .. :try_end_55} :catch_55
...
.method newWebSocketStreams(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLokio/BufferedSource;Lokio/BufferedSink;Lokhttp3/internal/connection/Exchange;)V
...
.method trackFailure(Ljava/io/IOException;)V
    ...
    invoke-virtual {v0, v2, p1}, Lokhttp3/internal/connection/RealConnectionPool;->connectFailed(Lokhttp3/Route;Ljava/io/IOException;)V
