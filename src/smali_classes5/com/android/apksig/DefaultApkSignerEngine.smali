...
.method private checkOutputApkNotDebuggableIfDebuggableMustBeRejected()V
    ...
    throw v0
    :try_end_13
    .catch Lcom/android/apksig/apk/ApkFormatException; {:try_start_5 .. :try_end_13} :catch_13
...
.method private static computeSha256DigestBytes([B)[B
    ...
    :try_end_5
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_5} :catch_e
...
.method private createSigningBlockSignerConfig(Lcom/android/apksig/DefaultApkSignerEngine$SignerConfig;ZI)Lcom/android/apksig/internal/apk/ApkSigningBlockUtils$SignerConfig;
    ...
    :try_end_2f
    .catch Ljava/security/InvalidKeyException; {:try_start_27 .. :try_end_2f} :catch_3f
    ...
    :try_end_3d
    .catch Ljava/security/InvalidKeyException; {:try_start_38 .. :try_end_3d} :catch_3f
...
.method public generateSourceStampCertificateDigest()[B
    ...
    :try_end_20
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_c .. :try_end_20} :catch_22
...
.method public outputJarEntries()Lcom/android/apksig/ApkSignerEngine$OutputJarSignatureRequest;
    ...
    :try_end_11c
    .catch Ljava/security/cert/CertificateException; {:try_start_111 .. :try_end_11c} :catch_1e3
    ...
    :try_end_14d
    .catch Ljava/security/cert/CertificateException; {:try_start_144 .. :try_end_14d} :catch_14f
...
.method public produceV4Signature(Lcom/android/apksig/util/DataSource;Ljava/io/OutputStream;)[B
    ...
    check-cast v0, [B
    :try_end_19
    .catch Ljava/security/InvalidKeyException; {:try_start_2 .. :try_end_19} :catch_1a
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_19} :catch_2b
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_2 .. :try_end_19} :catch_2d
...
.method public signV4(Lcom/android/apksig/util/DataSource;Ljava/io/File;Z)V
    ...
    :try_end_14
    .catch Ljava/security/InvalidKeyException; {:try_start_d .. :try_end_14} :catch_15
    .catch Ljava/io/IOException; {:try_start_d .. :try_end_14} :catch_20
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_d .. :try_end_14} :catch_22
