...
.method private callWithTimeout(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Z)Ljava/lang/Object;
    ...
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_12 .. :try_end_15} :catch_1d
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_12 .. :try_end_15} :catch_28
    ...
    throw v0
    :try_end_1d
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_19 .. :try_end_1d} :catch_1d
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_19 .. :try_end_1d} :catch_28
    ...
    :try_end_26
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_23 .. :try_end_26} :catch_1d
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_23 .. :try_end_26} :catch_28
...
.method public callUninterruptiblyWithTimeout(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    :try_end_12
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_f .. :try_end_12} :catch_22
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_f .. :try_end_12} :catch_14
...
.method public callWithTimeout(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    invoke-interface {v1, p2, p3, p4}, Ljava/util/concurrent/Future;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    :try_end_12
    .catch Ljava/lang/InterruptedException; {:try_start_f .. :try_end_12} :catch_22
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_f .. :try_end_12} :catch_28
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_f .. :try_end_12} :catch_14
...
.method public runWithTimeout(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)V
    ...
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_f .. :try_end_12} :catch_27
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_f .. :try_end_12} :catch_13
