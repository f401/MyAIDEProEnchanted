...
.method private ensureOpen()V
    ...
    :try_end_c
    .catch Ljava/security/PrivilegedActionException; {:try_start_4 .. :try_end_c} :catch_d
...
.method checkResource(Ljava/lang/String;ZLjava/util/jar/JarEntry;)Lsun/misc/Resource;
    ...
    :try_end_14
    .catch Ljava/net/MalformedURLException; {:try_start_1 .. :try_end_14} :catch_1a
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_14} :catch_1c
    .catch Ljava/security/AccessControlException; {:try_start_1 .. :try_end_14} :catch_1e
...
.method getResource(Ljava/lang/String;Z)Lsun/misc/Resource;
    ...
    invoke-direct {p0}, Lsun/misc/URLClassPath$JarLoader;->ensureOpen()V
    :try_end_f
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_f} :catch_2a
...
.method getResource(Ljava/lang/String;ZLjava/util/Set;)Lsun/misc/Resource;
    ...
    :try_end_47
    .catch Ljava/security/PrivilegedActionException; {:try_start_1d .. :try_end_47} :catch_b2
    .catch Ljava/net/MalformedURLException; {:try_start_1d .. :try_end_47} :catch_b4
    ...
    :try_end_53
    .catch Ljava/security/PrivilegedActionException; {:try_start_4b .. :try_end_53} :catch_b6
    .catch Ljava/net/MalformedURLException; {:try_start_4b .. :try_end_53} :catch_b8
    ...
    :try_end_5e
    .catch Ljava/io/IOException; {:try_start_5b .. :try_end_5e} :catch_8e
    ...
    :try_end_71
    .catch Ljava/security/PrivilegedActionException; {:try_start_6e .. :try_end_71} :catch_b6
    .catch Ljava/net/MalformedURLException; {:try_start_6e .. :try_end_71} :catch_b8
