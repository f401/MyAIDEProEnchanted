.class public Landroidj/support/v4/app/NotificationCompatKitKat$Builder;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroidj/support/v4/app/NotificationCompatKitKat;
.end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mActionExtrasList:Ljava/util/List;
    ...
    iput-object v4, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;

    if-eqz p20, :cond_0

    iget-object v4, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    iget-object v5, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    iput-object v0, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mContentView:Landroid/widget/RemoteViews;

    move-object/from16 v0, p25

    iput-object v0, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mBigContentView:Landroid/widget/RemoteViews;
...
.method public addAction(Landroidj/support/v4/app/NotificationCompatBase$Action;)V
    ...
    iget-object v0, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mActionExtrasList:Ljava/util/List;

    iget-object v1, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;
...
.method public build()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mExtras:Landroid/os/Bundle;
    ...
    :cond_0
    iget-object v0, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v1, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mContentView:Landroid/widget/RemoteViews;
    ...
    :cond_1
    iget-object v1, p0, Landroidj/support/v4/app/NotificationCompatKitKat$Builder;->mBigContentView:Landroid/widget/RemoteViews;
